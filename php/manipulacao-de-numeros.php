    ...
    <div class="container mt-5">
      <div class="row justify-content-center">
        <div class="col-md-8 bg-light">
          ...
          <?php 
          # ceil($num) arredonda o valor para cima
          # floor($num) arredonda para baixo
          # round($num) arrendonda com base nos valores decimais - modo automático
          # rand() gera numeros aleatórios
          # getrandmax() gera um valor máximo de numeros aleatórios com base no sistema operacional
          ...
          echo round($num).'<br>';
          # numero aleatorio - rand(inicio do intervalo, final do intervalo)
          # dois parâmetro de delimita a criação dos numeros
          echo rand().'<br>';
          echo getrandmax().'<br>';
          # raiz quadrada
          echo sqrt(25);
