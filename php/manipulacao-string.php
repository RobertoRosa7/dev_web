    ...
    <div class="container mt-5">
      <div class="row justify-content-center">
        <div class="col-md-8 bg-light">
          ...
          <h5>Manipulação de strings</h5>
          <?php 
          # strtolower($string) transforma todos os caracteres em minúsculos
          # strtoupper($string) transforma todos os caracteres em maiúsculos
          # ucfirst($string) transforma o primeiro caractere em maiúsculos
          # strlen($string) conta a quantidade de caracteres da string
          # str_replace('procura_por', 'substitui_por', $string) substituição de caracteres ou strings
          # substr($string, <posição inicial>, <qtde de caracteres>) retorna parte de uma string
          ...
          echo $texto.'<br>';
          echo str_replace('PHP', 'Java', $texto).'<hr>';

          # string que copia parte de outra string
          # o segundo parâmetro conta a posição inicial indicado pelos índices
          # o terceiro parâmetro conta a QUANTIDADE de caracter a partir da posição inicial
          echo $texto.'<br>';
