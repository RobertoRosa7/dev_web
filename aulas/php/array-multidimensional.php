    ...
    <div class="container mt-5">
      <div class="row justify-content-center">
        <div class="col-md-8 bg-light">
          ...
          <?php 
          # criação de array dentro de arrays
          $lista_coisas = [];
          $lista_coisas['frutas'] = array(1 => 'abacaxi', 2 => 'manga', 3 => 'uva');
          $lista_coisas['pessoas'] = [1 => 'João',2 => 'Maria', 3 => 'Jose'];
          echo '<pre>';
          print_r($lista_coisas['frutas']);
          print_r($lista_coisas['pessoas']);
          echo '</pre>';

          # acessando valores dos arrays multidimensionais
          print_r($lista_coisas['frutas'][2]);
          echo '<br>';
