    ...
    <div class="container mt-5">
      <div class="row justify-content-center">
        <div class="col-md-8 bg-light">
          ...
          <h5>Operadores aritmeticos</h5>
          <?php 
          # Funções: void - (não há retorno)
          function exibirTexto(){
            echo 'isto é uma função <br>';
          }
          exibirTexto();
          # Função: return (retorna um valor)
          function calcularArea($l, $c){
            $a = $l * $c;
            return $a;
          }
          echo calcularArea(20,30);

          /* funções de retorno podem ser encapsulada a variáveis, na prática usamos a função de retorno em casos
          * que temos um resultado genérico, isto é, o retorno do bloco de código precisará ser usado em outros
          * códigos, para as funções void, em apenas casos específicos 
          *
          */
          ?>
        </div>  
